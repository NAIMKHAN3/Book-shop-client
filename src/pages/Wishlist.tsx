    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:w-4/5 md:mx-auto mx-3 my-10'>
                {
                    wishlists.map((wishlist: any) => <div className='border-2 p-5 flex flex-col '>
                        <div className='h-80'>
                        ...
                        <div className='ml-4'>
                            ...
                            <div className='flex justify-end'>
                                <button onClick={() => handleDelete(wishlist?._id)} className=' font-semibold hover:bg-white border-red-500 border  duration-300 hover:text-black bg-red-600 text-white px-2 py-2 rounded-md mt-5 w-full'>Wishlist Delete</button>
                            </div>
                        </div>
                    </div>)
                }
