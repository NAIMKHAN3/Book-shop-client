...
const Wishlist = () => {
    ...
    return (
        <div>
            <Heading className='text-center text-3xl font-semibold mt-10'>Wishlist</Heading>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-3 w-4/5 mx-auto my-10'>
            {
                ...
                <button onClick={handleDelete} className='ml-4 font-semibold hover:bg-white border-red-500 border  duration-300 hover:text-black bg-red-600 text-white px-2 py-2 rounded-md mt-5'>Wishlist Delete</button>
                </div>
              </div>
                </div>)
            }
